...
exports.getPortfolios = (req, res) => {
	...
	//sort the portfolios by earliest starting date
...
exports.getPortfolioById = (req, res) => {
	...
	//this line is required to remove "-__v" property removed from portfolio model when using the update form and passing validation to remove "-__v" as one of the fields that need validation
