...
export class Portfolios extends Component {
  static async getInitialProps() {
	...
	displayDeleteWarning(portfolioId, e) {
		e.stopPropagation();
		const isConfirm = confirm('Are you sure you want to delete this portfolio? Do you want to delete this portfolio???');
  ...
  render() {
		...
		const { isAuthenticated, isSiteOwner } = this.props.auth;
    return (
      <BaseLayout title="James Park - Learn About My Experience" {...this.props.auth}>
